...
enemy_data["bursterbadass"] =
{
  kind = "bursterbadass", name = "Burster Badass",
  sprite = "bursterdude", death_sound = "grunt",
  animations = {
    bursterbadass_run_ne = animation.pinkerton_run_ne:clone(),
    bursterbadass_run_se = animation.pinkerton_run_se:clone(),
    bursterbadass_run_nw = animation.pinkerton_run_nw:clone(),
    bursterbadass_run_sw = animation.pinkerton_run_sw:clone(),
    bursterbadass_idle_ne = animation.pinkerton_idle_ne:clone(),
    bursterbadass_idle_se = animation.pinkerton_idle_se:clone(),
    bursterbadass_idle_nw = animation.pinkerton_idle_nw:clone(),
    bursterbadass_idle_sw = animation.pinkerton_idle_sw:clone(),
    bursterbadass_hurt_ne = animation.pinkerton_hurt_ne:clone(),
    bursterbadass_hurt_se = animation.pinkerton_hurt_se:clone(),
    bursterbadass_hurt_nw = animation.pinkerton_hurt_nw:clone(),
    bursterbadass_hurt_sw = animation.pinkerton_hurt_sw:clone(),
  },
