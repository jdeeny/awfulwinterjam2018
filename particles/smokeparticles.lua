...
function SmokeParticles:_createParticles(lifetime, scale)
  ...
  emitter:setColors(dark,dark,dark,19 + math.random()*15,  mid,mid,mid,3+ math.random()*3, light,light,light, 2+ math.random()*2)
  emitter:setSpread(PI * 0.25 + math.random() * PI *0.125)
  emitter:setSizes(.05 * scale, 1.6 * scale)
  ...
  emitter:setParticleLifetime(.6, 1.6)
