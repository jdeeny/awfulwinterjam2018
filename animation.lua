...
function animation.init()
  ...
  animation.remotedude_red_run_se = anim8.newAnimation(remotedude_grid('1-2',1), {0.5, 0.2})
  animation.remotedude_red_run_ne = anim8.newAnimation(remotedude_grid('3-4',1), {0.5, 0.2})
  animation.remotedude_red_run_sw = anim8.newAnimation(remotedude_grid('1-2',1), {0.5, 0.2}):flipH()
  animation.remotedude_red_run_nw = anim8.newAnimation(remotedude_grid('3-4',1), {0.5, 0.2}):flipH()

  animation.remotedude_blue_run_se = anim8.newAnimation(remotedude_grid('1-2',2), {0.5, 0.2})
  animation.remotedude_blue_run_ne = anim8.newAnimation(remotedude_grid('3-4',2), {0.5, 0.2})
  animation.remotedude_blue_run_sw = anim8.newAnimation(remotedude_grid('1-2',2), {0.5, 0.2}):flipH()
  animation.remotedude_blue_run_nw = anim8.newAnimation(remotedude_grid('3-4',2), {0.5, 0.2}):flipH()

  animation.remotedude_green_run_se = anim8.newAnimation(remotedude_grid('1-2',3), {0.5, 0.2})
  animation.remotedude_green_run_ne = anim8.newAnimation(remotedude_grid('3-4',3), {0.5, 0.2})
  animation.remotedude_green_run_sw = anim8.newAnimation(remotedude_grid('1-2',3), {0.5, 0.2}):flipH()
  animation.remotedude_green_run_nw = anim8.newAnimation(remotedude_grid('3-4',3), {0.5, 0.2}):flipH()
