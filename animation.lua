...
function animation.init()
  ...
  animation.sniper_run_sw = anim8.newAnimation(sniper_grid('1-10',2), 0.8):flipH()
  animation.sniper_run_nw = anim8.newAnimation(sniper_grid('1-10',1), 0.8):flipH()
  animation.sniper_run_se = anim8.newAnimation(sniper_grid('1-10',2), 0.8)
  animation.sniper_run_ne = anim8.newAnimation(sniper_grid('1-10',1), 0.8)
  animation.sniper_idle_sw = anim8.newAnimation(sniper_grid('1-1',3), 0.8):flipH()
  animation.sniper_idle_nw = anim8.newAnimation(sniper_grid('2-2',3), 0.8):flipH()
  animation.sniper_idle_se = anim8.newAnimation(sniper_grid('1-1',3), 0.8)
  animation.sniper_idle_ne = anim8.newAnimation(sniper_grid('2-2',3), 0.8)
