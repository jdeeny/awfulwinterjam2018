...
TileSet['opendoor']           = { Tile:new('floor',           'd'):setDoor(true):setSolid(false):setLayer(Layer.FURNITURE):setDestroyable('crumbles', 'rubblefloor', 150) }
TileSet['fakedoor']           = { Tile:new('floor')               :setDoor(true):setSolid(true):setLayer(Layer.FURNITURE):setDestroyable(false) }
